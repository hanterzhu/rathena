...
#define getunitdata_sub(idx__,var__) setd_sub_num(st,sd,name,(idx__),(var__),data->ref)
	...
	switch(bl->type) {
		case BL_MOB:
			...
			getunitdata_sub(UMOB_MONEY, md->status.extend.money);
			break;
...
BUILDIN_FUNC(setunitdata)
{
	...
	case BL_MOB:
		...
		switch (type) {
			...
			case UMOB_ATKMIN: md->base_status->rhw.atk = (unsigned int)value; calc_status = true; break;
			case UMOB_ATKMAX: md->base_status->rhw.atk2 = (unsigned int)value; calc_status = true; break;
			case UMOB_MATKMIN: md->base_status->matk_min = (unsigned int)value; calc_status = true; break;
			case UMOB_MATKMAX: md->base_status->matk_max = (unsigned int)value; calc_status = true; break;
            ...
            case UMOB_MONEY: md->base_status->extend.money = value; calc_status = true; break;
			default:
	...
	case BL_HOM:
		...
		switch (type) {
			...
			case UHOM_ATKMIN: hd->base_status.rhw.atk = (unsigned int)value; calc_status = true; break;
			case UHOM_ATKMAX: hd->base_status.rhw.atk2 = (unsigned int)value; calc_status = true; break;
			case UHOM_MATKMIN: hd->base_status.matk_min = (unsigned int)value; calc_status = true; break;
			case UHOM_MATKMAX: hd->base_status.matk_max = (unsigned int)value; calc_status = true; break;
	...
	case BL_PET:
		...
		switch (type) {
			...
			case UPET_ATKMIN: pd->status.rhw.atk = (unsigned int)value; break;
			case UPET_ATKMAX: pd->status.rhw.atk2 = (unsigned int)value; break;
			case UPET_MATKMIN: pd->status.matk_min = (unsigned int)value; break;
			case UPET_MATKMAX: pd->status.matk_max = (unsigned int)value; break;
	...
	case BL_MER:
		...
		switch (type) {
			...
			case UMER_ATKMIN: mc->base_status.rhw.atk = (unsigned int)value; calc_status = true; break;
			case UMER_ATKMAX: mc->base_status.rhw.atk2 = (unsigned int)value; calc_status = true; break;
			case UMER_MATKMIN: mc->base_status.matk_min = (unsigned int)value; calc_status = true; break;
			case UMER_MATKMAX: mc->base_status.matk_max = (unsigned int)value; calc_status = true; break;
	...
	case BL_ELEM:
		...
		switch (type) {
			...
			case UELE_ATKMIN: ed->base_status.rhw.atk = (unsigned int)value; calc_status = true; break;
			case UELE_ATKMAX: ed->base_status.rhw.atk2 = (unsigned int)value; calc_status = true; break;
			case UELE_MATKMIN: ed->base_status.matk_min = (unsigned int)value; calc_status = true; break;
			case UELE_MATKMAX: ed->base_status.matk_max = (unsigned int)value; calc_status = true; break;
	...
	case BL_NPC:
		...
		switch (type) {
			...
			case UNPC_ATKMIN: nd->status.rhw.atk = (unsigned int)value; break;
			case UNPC_ATKMAX: nd->status.rhw.atk2 = (unsigned int)value; break;
			case UNPC_MATKMIN: nd->status.matk_min = (unsigned int)value; break;
			case UNPC_MATKMAX: nd->status.matk_max = (unsigned int)value; break;
